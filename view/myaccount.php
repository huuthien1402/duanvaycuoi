...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">
    ...
    <div class="bodyy" style="margin-top: 50px;">
        <div class="form-dangky">
            <form action="index.php?pg=uppdateuser" style="border: 1px solid #d7d7d7" method="post">
                <div class="container" style="font-family: Arial, Helvetica, sans-serif;">
                    <h1>THÔNG TIN TÀI KHOẢN </h1>
                    <hr>

                    <label for="username"><b>Tên Đăng Nhập</b></label>
                    <input type="text" placeholder="Nhập Tên Đăng Nhập" id="username" value="<?= $username ?>" name="username" required>

                    <label for="email"><b>Email</b></label>
                    <input type="text" placeholder="Nhập Email" id="email" value="<?= $email ?>" name="email" required>

                    <label for="password"><b>Mật Khẩu</b></label>
                    <input type="password" placeholder="Nhập Mật Khẩu" id="password" value="<?= $password ?>" name="password" required>

                    <label for="hoten"><b>Họ Tên</b></label>
                    <input type="text" placeholder="Họ Tên" id="hoten" value="<?= $khachhang ?>" name="hoten" required>

                    <label for="diachi"><b>Địa Chỉ</b></label>
                    <input type="text" placeholder="Địa Chỉ" id="diachi" value="<?= $diachi ?>" name="diachi" required>

                    <label for="dienthoai"><b>Điện thoại</b></label>
                    <input type="text" placeholder="Điện Thoại" id="dienthoai" value="<?= $dienthoai ?>" name="dienthoai" required>

                    <div class="clearfix">
                        <button type="button" class="cancelbtn">Hủy Bỏ</button>
                        <input type="hidden" name="makh" value="<?= $makh ?>">
                        <button type="submit" name="capnhat" value="Cập Nhật" class="signupbtn">Cập Nhật</button>
                    </div>
                </div>
            </form>
        </div>
