...
<body>
        ...
        <link rel="stylesheet" href="./layout da1/chitietsp/chitietsp.css">
    <style>
        .thantrangct .boxchuattctsp .formmm input{
            border: none;
        ...
        .thantrangct .boxchuattctsp .formmm input:hover{
    ...
    <div class="thantrangct">
        <div class="boxchuahinhctsp">
            <img src="./layout da1/img/<?=$hinh?>" alt="">
        </div>
        <div class="boxchuattctsp">
            <div class="tenctsp">
                <h3><?=$tensp?></h3>
            </div>
            <div class="giactsp">
                <h3><?=number_format($giamoi, 0, ',', '.')?> đ</h3>
            </div>
            <div class="ndctsp">
                <p>Form dáng: xòe bồng, cổ V tay nữ hoàng</p>
                <p>Chất liệu: lưới dệt kim sa</p>
            ...
            <div class="bangdangki">
                <h6>ĐẶT HẸN THỬ VÁY</h6>
                <div style="margin-left: 20px;">
                    <p><b>Họ tên của bạn(*)</b></p>
                    <input type="text">
                    <p><b>Email liên hệ(*)</b></p>
                    <input type="text">
                    <p><b>Số điện thoại(*)</b></p>
                    <input type="text">
                    <p><b>Ngày đến thử váy(*)</b></p>
                    <input type="date">
                </div>

                <a href="#" style="text-decoration: none;">
                    <div class="buttondatlich">
                        <p>
                            ĐẶT LỊCH
                        </p>                        
                    </div>
